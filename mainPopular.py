...
def save_article_as_html(article, output_dir='articlesPopular', images_dir='imagesPopular'):
...
# Main function
def main():
    urls = read_urls('urlsPopular.txt')
    for url in urls:
        article = scrape_article(url)
        if article:
            html_file_path = save_article_as_html(article)
            upload_to_ftp('articlesPopular', 'articlesPopular')
            upload_images_to_ftp('imagesPopular', 'imagesPopular')
